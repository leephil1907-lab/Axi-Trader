...
export default function PositionsPage() {
  ...
  return <AxiAppShell active="Positions">
    <div className="mx-auto max-w-[1400px] px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
      <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-[10px] font-extrabold uppercase tracking-[.18em] text-[#e4002e]">Positions</p><h1 className="mt-2 text-4xl font-black tracking-[-.045em]">Open positions</h1><p className="mt-2 text-sm text-[#6c6f70]">Review your open positions from the connected trading account.</p></div><button type="button" onClick={() => window.location.reload()} className="rounded-md border border-[#d4d3d0] bg-white p-3" aria-label="Refresh positions"><RefreshCw className="h-4 w-4" /></button></div>
