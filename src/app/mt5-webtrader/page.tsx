      ...
      <header className="bg-white border-b border-axi-border px-4 py-2 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <Monitor size={18} className="text-axi-gold" />
            <span className="text-sm font-bold text-axi-text">MetaTrader 5</span>
            <span className="px-1.5 py-0.5 bg-axi-gold/10 text-axi-red text-[9px] font-bold rounded uppercase">Web</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button onClick={() => setIsLive(!isLive)} className={`p-1.5 rounded transition-colors ${isLive ? "bg-axi-success/10 text-axi-success" : "bg-axi-gold/10 text-axi-red"}`}>
            ...
            {watchlist.map((sym) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-3 py-2 text-left transition-colors ${activeSymbol === sym ? "bg-axi-gold/10 border-l-2 border-axi-gold" : "hover:bg-axi-cream"}`}
                >
